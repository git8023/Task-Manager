...
function StringUtil() {
    ...
    this.firstUpperCase = function(target) {
        if ($thisObj.isEmpty(target, true)) { return target; }
     ...
     * @param suffix
     *            后缀
     * @deprecated 当前接口已废弃, 当前接口容易让调用者混淆; 相同功能应调用{@link stringUtil.maxLen(String, Number, String)}
     */
...
//function isOnline(onFn,offFn,url,context){
//    offFn=!(offFn instanceof Function)||function(){},
//    url=(!!url?url:"http://www.beian.gov.cn/img/ghs.png");
//    if(//)
//    
//    "_=" + new Date().getTime();
//    var i = new Image();
//    i.onload = function(){(onFn instanceof Function)&&(onFn.apply(context||this));};
//    i.onerror = function(){(offFn instanceof Function)&&(offFn.apply(context||this));};;
//    i.src =url;
//}