...
<head>
    ...
    <title>title</title>
    <link rel="stylesheet" type="text/css" href="<%=basePath %>static/css/taskDetails.css" />
    <script type="text/javascript" src="<%=basePath %>static/js/taskDetails.js"></script>
</head>
<body>
    ...
    <div class="task_view" style="margin-top:-10px;">
        ...
        <div class="task_detail">
            <form action="module/addModule.cmd">
                <input type="hidden" name="id" id="taskId" value="${requestScope.param.taskId[0] }"/>
